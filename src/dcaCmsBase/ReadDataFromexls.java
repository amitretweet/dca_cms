...
public class ReadDataFromexls {
    ...
    public int getDataInt(int sheetno, int row, int col)                                   
    {                                                                                      
        sheet=wb.getSheetAt(sheetno);                                                      
    ...
    public long getDataLong(int sheetno, int row, int col)                                   
    {                                                                                      
        sheet=wb.getSheetAt(sheetno);                                                      
    ...
    public float getDataFloat(int sheetno, int row, int col)                                   
    {                                                                                      
        sheet=wb.getSheetAt(sheetno);                                                      
        float data=(float) sheet.getRow(row).getCell(col).getNumericCellValue();               
        return data;                                                                       
    } 
